...
[![Status](https://img.shields.io/badge/status-0.6.0-blue.svg)](#status)
...
> **Read [Status](#status) before planning anything.** At `0.6.0` this is a classifier, not a
...
**0.6.0.** Precise, because a tool that overstates itself does damage quietly. Every row was
